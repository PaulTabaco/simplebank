...
// Source: parus.i234.me/paultabaco/simplebank/db/sqlc (interfaces: Store)
...
// GetAccountForUpdare mocks base method.
func (m *MockStore) GetAccountForUpdare(arg0 context.Context, arg1 int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountForUpdare", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccountForUpdare indicates an expected call of GetAccountForUpdare.
func (mr *MockStoreMockRecorder) GetAccountForUpdare(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountForUpdare", reflect.TypeOf((*MockStore)(nil).GetAccountForUpdare), arg0, arg1)
}
